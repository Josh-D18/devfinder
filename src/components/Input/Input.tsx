  ...
  return (
    <form className="flex justify-center ">
      ...
      <div className="absolute">
        <button
          type="submit"
          className="bg-secondary-500 rounded-[10px] w-[84px] h-[46px] relative top-[1px] left-[120px] mr-[7px] mb-[7.5px] mt-[6.5px] text-secondary-400 md:left-[230px] md:top-[3px] md:w-[106px] md:h-[50px]"
        >
          Search
        </button>
      </div>
